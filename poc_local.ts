...
// Dari output_protocol_baru3.txt (Digest: ACyf4wQdLapqfeP4tQ7UAarnX7PRCWe8mkUagHSfd4zd)
const PKG = "0xf651778d98fc4183a5a379c4e1b4e2d49c145e952416523d8569fe84bbfceb83";
const VERSION = "0x602c9e4d1efc55f2980fe90c0a9cad3d27c1a21b5ef775abcacdfe9c0bf2ff59";
const MARKET = "0x90fa7276cf7242c4948c159bad9e97c194e116eb3aa84d48c34b6de66fd3e6a4";
const ORACLE = "0xac7470f0d3f5e650fcec39ad419237cfb0b506f0e2f531d44b03ebb7a827503b";
const REGISTRY = "0x189136dcb09c94c45e16d1a7fc56447f62082930e27a61c50556616c677b9751";
const CLOCK = "0x6";

// Dari output_testcoin_baru3.txt (Digest: 87ZLVg4sEhiwYfmRtMp4S4rjkTpV14VgDFK6utZtcPT9)
const TEST_COIN_PKG = "0x806d6bd7369d44957a60031533b79949c776e40fd1d1ee6e4af223cdf7d9e95b";
const USDC_TYPE = `${TEST_COIN_PKG}::usdc::USDC`;
const ETH_TYPE = `${TEST_COIN_PKG}::eth::ETH`;
const SUI_TYPE = "0x2::sui::SUI";

const USDC_TREASURY = "0x8a31173b759500656fe7fe5d87f25e4d6ad355868e94b1ca3a06fbc0de9e4608";
const ETH_TREASURY = "0x353217f0b79f51e3225c24edfcfd258e728a0f29c14a38349e6378919633a69e";
...
async function initializeMarket(adminCapId) {
    ...
    // FIX: daftarkan borrow limit agar borrow::borrow tidak abort EFieldDoesNotExist
    ...
    // FIX: daftarkan borrow fee agar borrow::borrow tidak abort EFieldDoesNotExist
